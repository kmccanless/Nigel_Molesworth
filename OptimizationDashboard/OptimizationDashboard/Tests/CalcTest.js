...
test("Data correct in 1st KPI of top row", function () {
    ...
    equal(S('#id_1_1 #kpi_type').text(), "Percentage", "Type Test");
...
test("Data correct in 2nd KPI of top row", function () {
    ...
    equal(S('#id_1_2 #kpi_type').text(), "Minutes", "Type Test");
...
test("Data correct in 3rd KPI of top row", function () {
    ...
    equal(S('#id_1_3 #kpi_type').text(), "Amount", "Type Test");
    equal(S('#id_1_3 #kpi_units').text(), "25", "Units Test");
    equal(S('#id_1_3 #kpi_formatted_value').text(), "7", "formattedValue Test");
    equal(S('#id_1_3 #kpi_formatted_target').text(), "9", "formattedText Test");
    equal(S('#id_1_3 #kpi_firstWarn').text(), "250", "firstWarn Test");
    equal(S('#id_1_3 #kpi_secondWarn').text(), "275", "secondWarn Test");
});

//13
test("Data correct in 4th KPI of top row", function () {
    equal(S('#id_1_4 #kpi_title').text(), "KPI4", "Title Test");
    equal(S('#id_1_4 #kpi_type').text(), "Quantity", "Type Test");
    ...
    equal(S('#id_1_4 #kpi_firstWarn').text(), "250", "firstWarn Test");
...
test("Data correct in 5th KPI of top row", function () {
    ...
    equal(S('#id_1_5 #kpi_type').text(), "Percentage", "Type Test");
...
test("Data correct in 1st KPI of top row", function () {
    ...
    equal(S('#id_2_1 #kpi_type').text(), "Percentage", "Type Test");
    ...
    equal(S('#id_2_1 #kpi_firstWarn').text(), "180", "firstWarn Test");
    equal(S('#id_2_1 #kpi_secondWarn').text(), "190", "secondWarn Test");
});

//16
test("Data correct in 2nd KPI of top row", function () {
    equal(S('#id_2_2 #kpi_title').text(), "KPI2", "Title Test");
    equal(S('#id_2_2 #kpi_type').text(), "Minutes", "Type Test");
...
test("Data correct in 3rd KPI of top row", function () {
    ...
    equal(S('#id_2_3 #kpi_type').text(), "Amount", "Type Test");
...
test("Data correct in 4th KPI of top row", function () {
    ...
    equal(S('#id_2_4 #kpi_type').text(), "Quantity", "Type Test");
...
test("Data correct in 5th KPI of top row", function () {
    ...
    equal(S('#id_2_5 #kpi_type').text(), "Percentage", "Type Test");
