...
namespace Models
{
    ...
    public class KPI_JSONTest
    {
        ...
        {
            string expectedjson = @"{""userName"":""User"",""roleName"":""Role"",""activeLocation"":""1"",""locations"":[""1"",""3"",""5""],""workspaces"":[{""id"":1,""KPIs"":[{""title"":""Total Compliance"",""ordinal"":1,""type"":""02"",""target"":207.0,""units"":230.0,""firstWarn"":195.5,""secondWarn"":184.0},{""title"":""Locked Loads"",""ordinal"":2,""type"":""02"",""target"":11.4,""units"":228.0,""firstWarn"":22.8,""secondWarn"":34.2}]},{""id"":2,""KPIs"":[{""title"":""First Load"",""ordinal"":1,""type"":""01"",""target"":370.0,""units"":36.0,""firstWarn"":740.0,""secondWarn"":1110.0},{""title"":""Job Wait"",""ordinal"":2,""type"":""01"",""target"":416.0,""units"":40.0,""firstWarn"":624.0,""secondWarn"":832.0},{""title"":""Yard Time"",""ordinal"":3,""type"":""01"",""target"":600.0,""units"":40.0,""firstWarn"":800.0,""secondWarn"":1000.0}]}]}";
